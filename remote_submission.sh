...
#python Stubborn/collect.py -v 0 --dump_location ./data/tmp --exp_name vis4_tg --print_images 1  --toiletgrow 0 --evaluation $AGENT_EVALUATION_TYPE $@ 
...
python Stubborn/collect.py --sem_gpu_id 1 --exp_name tf_gr5_oldstair --print_images 0 --alpha 250 --evaluation $AGENT_EVALUATION_TYPE $@ &
