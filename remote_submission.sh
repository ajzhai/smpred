...
python Stubborn/collect_slam.py -v 0 --sem_gpu_id 1 --exp_name gridslam1h --print_images 0 --alpha 100 --switch_step 0 --start_ep 100 --end_ep 200 --evaluation $AGENT_EVALUATION_TYPE $@ &
...
python Stubborn/collect_slam.py -v 0 --sem_gpu_id 1 --exp_name gridslam4h --print_images 0 --alpha 100 --switch_step 0 --start_ep 400 --end_ep 500 --evaluation $AGENT_EVALUATION_TYPE $@ &
