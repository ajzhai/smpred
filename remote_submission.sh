...
# python Stubborn/collect_slam.py -v 0 --sem_gpu_id 6 --exp_name gridslam0 --print_images 0 --alpha 100 --switch_step 0 --start_ep 0 --end_ep 100 --evaluation $AGENT_EVALUATION_TYPE $@ &
# python Stubborn/collect_slam.py -v 0 --sem_gpu_id 6 --exp_name gridslam1 --print_images 0 --alpha 100 --switch_step 0 --start_ep 100 --end_ep 200 --evaluation $AGENT_EVALUATION_TYPE $@ &
# python Stubborn/collect_slam.py -v 0 --sem_gpu_id 6 --exp_name gridslam2 --print_images 0 --alpha 100 --switch_step 0 --start_ep 200 --end_ep 300 --evaluation $AGENT_EVALUATION_TYPE $@ &
python Stubborn/collect_slam.py -v 0 --sem_gpu_id 0 --exp_name gridslam3n --print_images 0 --alpha 100 --switch_step 0 --start_ep 300 --end_ep 400 --evaluation $AGENT_EVALUATION_TYPE $@ &
python Stubborn/collect_slam.py -v 0 --sem_gpu_id 1 --exp_name gridslam4n --print_images 0 --alpha 100 --switch_step 0 --start_ep 400 --end_ep 500 --evaluation $AGENT_EVALUATION_TYPE $@ &
