...
python Stubborn/collect_slam.py -v 0 --sem_gpu_id 6 --exp_name gridslam3 --print_images 0 --alpha 100 --switch_step 0 --start_ep 300 --end_ep 400 --evaluation $AGENT_EVALUATION_TYPE $@ &
python Stubborn/collect_slam.py -v 0 --sem_gpu_id 6 --exp_name gridslam4 --print_images 0 --alpha 100 --switch_step 0 --start_ep 400 --end_ep 500 --evaluation $AGENT_EVALUATION_TYPE $@ &
