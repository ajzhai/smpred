...
python Stubborn/collect.py --sem_gpu_id 0 --exp_name tf_eo120_stair15_es8 --print_images 0 --escape 800 --evaluation $AGENT_EVALUATION_TYPE $@ &
python Stubborn/collect.py --sem_gpu_id 0 --exp_name tf_eo120_stair15_es12 --print_images 0 --escape 1200 --evaluation $AGENT_EVALUATION_TYPE $@ &
