...
python Stubborn/collect.py --sem_gpu_id 0 --exp_name tf_gr6_eo_stair25 --print_images 0 --alpha 250 --toiletrad 6 --evaluation $AGENT_EVALUATION_TYPE $@ &
python Stubborn/collect.py --sem_gpu_id 0 --exp_name tf_gr5_eo_stair25 --print_images 0 --alpha 250 --toiletrad 5 --evaluation $AGENT_EVALUATION_TYPE $@ &
