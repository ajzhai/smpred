...
python Stubborn/collect.py --sem_gpu_id 0 --exp_name r50_bi --print_images 0 --sem_pred_prob_thr 0.9 --smp_step 10 --switch_step 19 --alpha 250 --col_rad 4 --start_ep 0 --escape 1 --evaluation $AGENT_EVALUATION_TYPE $@ &
python Stubborn/collect.py --sem_gpu_id 0 --exp_name r50_bi_ge2 --goal_erode 2 --print_images 0 --sem_pred_prob_thr 0.9 --smp_step 10 --switch_step 19 --alpha 250 --col_rad 4 --start_ep 0 --escape 1 --evaluation $AGENT_EVALUATION_TYPE $@ &
