...
#python Stubborn/collect.py -v 0 --dump_location ./data/tmp --exp_name vis1 --print_images 1  --evaluation $AGENT_EVALUATION_TYPE $@ 
...
python Stubborn/collect.py --sem_gpu_id 0 --exp_name tf_gr6_eo120_stair25 --print_images 0 --alpha 250 --toiletrad 6 --evaluation $AGENT_EVALUATION_TYPE $@ &
python Stubborn/collect.py --sem_gpu_id 0 --exp_name tf_gr5_eo120_stair25 --print_images 0 --alpha 250 --toiletrad 5 --evaluation $AGENT_EVALUATION_TYPE $@ &
