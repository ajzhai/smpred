...
# python Stubborn/collect.py --sem_gpu_id 4 --start_ep 0 --end_ep 2000 --timestep_limit 1000 --evaluation $AGENT_EVALUATION_TYPE $@  &
# python Stubborn/collect.py --sem_gpu_id 4 --start_ep 2000 --end_ep 4000 --timestep_limit 1000 --evaluation $AGENT_EVALUATION_TYPE $@  &
# python Stubborn/collect.py --sem_gpu_id 4 --start_ep 4000 --end_ep 6000 --timestep_limit 1000 --evaluation $AGENT_EVALUATION_TYPE $@  &
# python Stubborn/collect.py --sem_gpu_id 4 --start_ep 6000 --end_ep 8000 --timestep_limit 1000 --evaluation $AGENT_EVALUATION_TYPE $@  &
