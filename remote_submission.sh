...
python Stubborn/collect.py --sem_gpu_id 0 --exp_name tf_eoo_stair15_es8 --print_images 0 --escape 800 --evaluation $AGENT_EVALUATION_TYPE $@ &
python Stubborn/collect.py --sem_gpu_id 0 --exp_name tf_eoo_stair15_es16 --print_images 0 --escape 1600 --evaluation $AGENT_EVALUATION_TYPE $@ &
