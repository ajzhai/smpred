...
python Stubborn/collect_slam.py -v 0 --sem_gpu_id 3 --exp_name slam2 --print_images 0 --alpha 100 --pose_noise_std 0.0 --switch_step 0  --evaluation $AGENT_EVALUATION_TYPE $@ 
