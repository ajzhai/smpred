...
python Stubborn/collect.py --sem_gpu_id 0 --exp_name tf_eoo_oldstair_es7 --print_images 0 --escape 700 --evaluation $AGENT_EVALUATION_TYPE $@ &
python Stubborn/collect.py --sem_gpu_id 0 --exp_name tf_eoo_oldstair_es9 --print_images 0 --escape 900 --evaluation $AGENT_EVALUATION_TYPE $@ &
