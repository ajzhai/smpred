...
python Stubborn/collect.py --sem_gpu_id 0 --exp_name tf_gr6_srh0_stair15 --print_images 0 --alpha 250 --toiletrad 6 --evaluation $AGENT_EVALUATION_TYPE $@ &
python Stubborn/collect.py --sem_gpu_id 0 --exp_name tf_gr5_srh0_stair15 --print_images 0 --alpha 250 --toiletrad 5 --evaluation $AGENT_EVALUATION_TYPE $@ &
