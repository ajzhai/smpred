...
#python Stubborn/collect.py -v 0 --dump_location ./data/tmp --exp_name debug --print_images 1 --sem_pred_prob_thr 0.9 --smp_step 10 --switch_step 19 --alpha 400 --col_rad 4 --start_ep 11 --sf_thr '-2' --evaluation $AGENT_EVALUATION_TYPE $@ 
...
python Stubborn/collect.py --sem_gpu_id 3 --exp_name dder --print_images 0 --sem_pred_prob_thr 0.9 --smp_step 10 --switch_step 19 --alpha 400 --dd_erode 1 --start_ep 0 --evaluation $AGENT_EVALUATION_TYPE $@ &
python Stubborn/collect.py --sem_gpu_id 3 --exp_name large --print_images 0 --sem_pred_prob_thr 0.9 --smp_step 10 --switch_step 19 --alpha 400 --global_downscaling 2 --start_ep 0 --evaluation $AGENT_EVALUATION_TYPE $@ &
python Stubborn/collect.py --sem_gpu_id 3 --exp_name no_ot --print_images 0 --sem_pred_prob_thr 0.9 --smp_step 10 --switch_step 19 --alpha 400 --col_rad 4 --start_ep 0 --oventrick 0 --evaluation $AGENT_EVALUATION_TYPE $@ &
