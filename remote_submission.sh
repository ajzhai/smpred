...
python Stubborn/collect_mp3d.py -v 0 --sem_gpu_id 2 --exp_name mp3d_a100_inh2 --print_images 0 --alpha 100 --inhib_mode 2 --evaluation $AGENT_EVALUATION_TYPE $@ &
python Stubborn/collect_mp3d.py -v 0 --sem_gpu_id 2 --exp_name mp3d_a150_inh0 --print_images 0 --alpha 150 --inhib_mode 0 --evaluation $AGENT_EVALUATION_TYPE $@ &
python Stubborn/collect_mp3d.py -v 0 --sem_gpu_id 2 --exp_name mp3d_a150_inh2 --print_images 0 --alpha 150 --inhib_mode 2 --evaluation $AGENT_EVALUATION_TYPE $@ &
