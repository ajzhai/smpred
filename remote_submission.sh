...
#python Stubborn/collect.py -v 0 --dump_location ./data/tmp --exp_name debug --print_images 1 --start_ep 55 --evaluation $AGENT_EVALUATION_TYPE $@ 
...
python Stubborn/collect.py --sem_gpu_id 0 --exp_name tf_gr8_oldstair --print_images 0 --alpha 250 --evaluation $AGENT_EVALUATION_TYPE $@ &
